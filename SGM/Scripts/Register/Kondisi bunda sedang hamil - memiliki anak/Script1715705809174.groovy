...
WebUI.click(findTestObject('Register/Value Sedang Hamil-Memiliki Anak'))
...
WebUI.click(findTestObject('Register/Input Tanggal Lahir Anak'))

WebUI.sendKeys(findTestObject('Register/Input Tanggal Lahir Anak'), Keys.chord('15-12-2019', Keys.ENTER))
